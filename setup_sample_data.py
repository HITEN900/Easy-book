...
print("="*60)
print("🚀 EASY BOOK - SAMPLE DATA SETUP")
print("="*60)
...
for i, bus_data in enumerate(sample_buses):
    ...
    create_seats_for_bus(bus, bus_data['layout'], bus_data['seats'])
    print(f"\n✓ Bus created: {bus.bus_name} ({bus.bus_number}) with {bus.total_seats} seats")
...
print("3. Search for buses using the routes shown above")
print("4. Login or signup as customer")
print("5. Select seats and book tickets!")
print("="*60)